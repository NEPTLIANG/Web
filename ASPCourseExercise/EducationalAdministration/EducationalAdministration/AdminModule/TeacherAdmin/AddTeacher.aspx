<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddTeacher.aspx.cs" Inherits="EducationalAdministration.AdminModule.TeacherAdmin.AddTeacher" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="card" >
            工号<asp:TextBox ID="txtTno" runat="server"></asp:TextBox>
            <br />
            姓名<asp:TextBox ID="txtTname" runat="server"></asp:TextBox>
            <br />
            ...
            <br />
            部门<asp:DropDownList ID="ddlDepart" runat="server" DataSourceID="SqlDataSource1" DataTextField="name" DataValueField="no">
            </asp:DropDownList>
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="Data Source=localhost;Initial Catalog=EducationalAdministration;Integrated Security=True" ProviderName="System.Data.SqlClient" SelectCommand="SELECT [no], [name] FROM [department]"></asp:SqlDataSource>
            <br />
            职称<asp:TextBox ID="txtProf" runat="server"></asp:TextBox>
            <br />
