<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddAdmin.aspx.cs" Inherits="EducationalAdministration.AdminModule.AdminAdmin.AddAdmin" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="card">
            账号<asp:TextBox ID="txtId" runat="server" OnTextChanged="txtId_TextChanged"></asp:TextBox>
            <br />
