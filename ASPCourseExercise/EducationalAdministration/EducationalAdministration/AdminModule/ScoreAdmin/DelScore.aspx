<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DelScore.aspx.cs" Inherits="EducationalAdministration.AdminModule.ScoreAdmin.DelScore" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="card" >
            选择课程：<asp:DropDownList ID="ddlCno" runat="server" DataSourceID="SqlDataSource1" DataTextField="cname" DataValueField="cno">
            </asp:DropDownList>
            ...
            <br />
            选择学生：<asp:DropDownList ID="ddlSno" runat="server" DataSourceID="SqlDataSourceStudent" DataTextField="sname" DataValueField="sno">
            </asp:DropDownList>
