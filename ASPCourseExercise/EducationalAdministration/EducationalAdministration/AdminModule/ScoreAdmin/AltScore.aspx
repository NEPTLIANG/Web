<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AltScore.aspx.cs" Inherits="EducationalAdministration.AdminModule.ScoreAdmin.AltScore" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="card" >
            选择课程：<asp:DropDownList ID="ddlCourse" runat="server" DataSourceID="SqlDataSourceCourse" DataTextField="cname" DataValueField="cno" OnSelectedIndexChanged="ddlCourse_SelectedIndexChanged" OnTextChanged="ddlCourse_SelectedIndexChanged">
            </asp:DropDownList>
            <asp:SqlDataSource ID="SqlDataSourceCourse" runat="server" ConnectionString="Data Source=localhost;Initial Catalog=EducationalAdministration;Integrated Security=True" ProviderName="System.Data.SqlClient" SelectCommand="SELECT [cno], [cname] FROM [course]"></asp:SqlDataSource>
            <br />
            ...
            <br />
            原成绩：<asp:Label ID="lblOldGrade" runat="server" Text="请在上方选择课程及学生后点击确定按钮"></asp:Label>
            <br />
            新成绩：<asp:TextBox ID="txtNewGrade" runat="server"></asp:TextBox>
            <br />
