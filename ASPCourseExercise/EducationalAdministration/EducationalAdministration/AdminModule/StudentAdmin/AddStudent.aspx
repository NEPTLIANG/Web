<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddStudent.aspx.cs" Inherits="EducationalAdministration.AdminModule.StudentAdmin.AddStudent" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="card" >
            ...
            <br />
            姓名<asp:TextBox ID="txtSname" runat="server"></asp:TextBox>
            <br />
            ...
            <br />
            专业<asp:TextBox ID="txtSpecialty" runat="server"></asp:TextBox>
            <br />
