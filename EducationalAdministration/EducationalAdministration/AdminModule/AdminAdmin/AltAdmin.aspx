<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AltAdmin.aspx.cs" Inherits="EducationalAdministration.AdminModule.AdminAdmin.AltAdmin" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="card">
            选择管理员：<asp:DropDownList ID="ddlAdmin" runat="server" DataSourceID="SqlDataSourceTeacher" DataTextField="adminID" DataValueField="adminID">
            </asp:DropDownList>
            <asp:SqlDataSource ID="SqlDataSourceTeacher" runat="server" ConnectionString="Data Source=localhost;Initial Catalog=EducationalAdministration;Integrated Security=True" ProviderName="System.Data.SqlClient" SelectCommand="SELECT [adminID] FROM [admin]"></asp:SqlDataSource>
            <br />
            新账号：<asp:TextBox ID="txtId" runat="server"></asp:TextBox>
            <br />
            新密码：<asp:TextBox ID="txtPwd" runat="server"></asp:TextBox>
            <br />
