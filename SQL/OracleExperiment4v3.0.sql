CREATE TABLE book(bookid CHAR(10),booknum NUMBER,bookname VARCHAR2(20),bookpress VARCHAR2(50),bookprice NUMBER,typeid CHAR(10),booktime DATE);
...
CREATE TABLE lend(bookid CHAR(10), readid CHAR(5), borrowdate DATE);
